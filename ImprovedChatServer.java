				...
				if (numUsers < MaxUsers)
				{
					try
					{
						...
						synchronized (this)
						{
							...
							newSocket.getOutputStream().write("Hello\n".getBytes());
							//check if client responds with Hello as well
							String handShake = tempReader.readLine();
							if (!"Hello".equals(handShake)) {
								//if not Hello, close socket and wait for a new connection
								newSocket.close();
								continue;
							}
